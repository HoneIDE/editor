...
impl DemoEditor {
    ...
    fn render(&self) {
        ...
        unsafe {
            (*editor).set_cursor(cursor_x, cursor_y, 0);
        }
...
fn main() {
    unsafe {
        ...
        (*editor).set_font("Consolas", 14.0);

        let char_width = (*editor).measure_text("M");
        ...
        (*editor).add_context_menu_item("Uppercase Selection", "menu:uppercase");
