...
//!
//! Shares Core Text rendering logic with the macOS crate.
//! Uses UIKit (UIView) instead of AppKit (NSView) for the view layer.
//! Touch handling converts iOS gestures to editor actions.
...
// FFI contract — identical signatures to macOS
